        ...
        NativeAd(
          ...
          listener: NativeAdListener(
            onAdLoaded: (Ad ad) {
              ...
              print('$NativeAd loaded. ${ad.responseInfo}');
              setState(() {
          ...
          nativeTemplateStyle: NativeTemplateStyle(
            ...
            callToActionTextStyle: NativeTemplateTextStyle(
                size: 16.0, backgroundColor: context.color.tertiaryColor),
...
class NativeAdInjector {
  ...
  call(Function(AdConditions conditions) builder) {
    AdConditions adConditions = AdConditions();
  ...
  void wrapper({
    ...
    try {
      ...
      if (isLimitReached == false && checkListLimitCondition == true) {
        arrangeIndex();
        for (int index in totalAddedAds) {
  ...
  List<int> findIndices(List<NativeAdWidgetContainer> list,
  ...
  void arrangeIndex() {
    int lastIndex = totalAddedAds.lastOrNull ?? 0;
...
class AdConditions {
  ...
  AdConditions setInjectSetting({
    ...
    injectCount.per = perLength;
    injectCount.count = count;
    return this;
  }
