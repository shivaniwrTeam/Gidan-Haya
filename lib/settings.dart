...
class AppSettings {
  ///Basic Settings
  static const String applicationName = 'Gidan Haya';
  static const String androidPackageName = 'com.app.gidanhaya';

  ///API Setting
  static const String hostUrl = 'https://muhab.gidanhaya.net/';
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  static String? priceFormat = 'en'; //keep null if you want to use default one

  ///supported

  ///Native deep link
  static const String shareNavigationWebUrl = 'muhab.gidanhaya.net';
  ...
  static const String deepLinkPrefix =
      'https://gidanhaya.page.link'; //demo.page.link

  ///set anything you want
  static const String deepLinkName = 'gidanhaya.com'; //deeplink demo.com
  ///!TODO: End deprecated
