...
class _MyAdvertismentScreenState extends State<MyAdvertismentScreen> {
  ...
  void initState() {
    context.read<FetchMyPromotedPropertysCubit>().fetchMyPromotedPropertys(
        callInfo: CallInfo(
            from: 'init|my promoted properties',
            fromFile: 'my_advertisment_screen'));
      ...
      if (context.read<FetchMyPromotedPropertysCubit>().hasMoreData()) {
        context
            ...
            .fetchMyPromotedPropertysMore(
                callInfo: CallInfo(
                    from: 'listener|my promoted properties|more',
                    fromFile: 'my_advertisment_screen'));
      }
    }
  }
                ...
                onRetry: () {
                  context
                      ...
                      .fetchMyPromotedPropertys(
                          callInfo: CallInfo(
                              from: 'No internet|my properties',
                              fromFile: 'my_advertisment_screen'));
                },
              );
            }
              ...
              return NoDataFound(
                ...
                onTap: () {
                  context
                      ...
                      .fetchMyPromotedPropertys(
                          callInfo: CallInfo(
                              from: 'no data|my promoted properties',
                              fromFile: 'my_advertisment_screen'));
                  setState(() {});
                },
              );
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      print('lasdjalsdj ${property.title}');
                                                  ...
                                                  if (Constant.isDemoModeOn) {
                                                    ...
                                                    context
                                                        ...
                                                        .delete(
                                                            ...
                                                            callInfo: CallInfo(
                                                                from:
                                                                    'delete|my advertiesment',
                                                                fromFile:
                                                                    'my_advertisment_screen'));
                                                  }
                                                },
