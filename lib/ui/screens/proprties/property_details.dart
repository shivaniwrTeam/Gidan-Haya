...
import 'package:ebroker/ui/screens/analytics/analytics_screen.dart';
...
class PropertyDetailsState extends State<PropertyDetails>
  ...
  void initState() {
    ...
    context.read<GetSubsctiptionPackageLimitsCubit>().getLimits(
        ...
        callInfo: CallInfo(from: 'init state', fromFile: 'property_details'));
  ...
  void setViewdProperty() {
    if (property!.addedBy.toString() != HiveUtils.getUserId()) {
      context.read<SetPropertyViewCubit>().set(property!.id!.toString(),
          callInfo: CallInfo(from: 'when enter', fromFile: 'property_details'));
    }
  }
                                ...
                                Future.delayed(Duration.zero, () {
                                  context
                                      ...
                                      .update(
                                        ...
                                        callInfo: CallInfo(
                                            from: 'Property status change',
                                            fromFile: 'property_details'),
                                      );
                                });
                              }
                            },
          ...
          child: UiUtils.buildButton(
            ...
            onPressed: () {
              ...
              context.read<ChangeInterestInPropertyCubit>().changeInterest(
                  ...
                  interest: interest,
                  callInfo: CallInfo(from: 'interest'));
            },
      ...
      if (_bottomSheetScrollController.isEndReached()) {
        if (widget.interestedUserCubitReference.hasMoreData()) {
          widget.interestedUserCubitReference.fetchMore(
              callInfo: CallInfo(
                  from: 'listener|fetchmore', fromFile: 'property_details'));
        }
      }
    });
